...
import { Github, Twitter, Linkedin, Clock, Bot, Shield, Moon, Sun, Code, GitBranch, GitCommit, Instagram } from 'lucide-react'
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-100 to-gray-200 dark:from-gray-900 dark:to-black text-gray-900 dark:text-white">
      <nav className="container mx-auto px-4 py-6 flex justify-between items-center">
        <Link to="/" className="text-2xl font-bold">CommitBridge</Link>
      ...
      <main className="container mx-auto px-4 py-12">
        <motion.section className="mb-20" {...fadeIn}>
          <h2 className="text-3xl font-semibold mb-12 text-center text-teal-600 dark:text-teal-400">Key Features</h2>
        ...
        <motion.section className="mb-20" {...fadeIn}>
          <h2 className="text-3xl font-semibold mb-12 text-center text-teal-600 dark:text-teal-400">How It Works</h2>
          <div className="flex flex-col md:flex-row justify-center items-center space-y-8 md:space-y-0 md:space-x-8">
            <Card className="bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700 w-full md:w-1/3">
              <CardHeader>
            ...
            <GitBranch className="w-8 h-8 text-teal-600 dark:text-teal-400 transform rotate-90 md:rotate-0" />
            <Card className="bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700 w-full md:w-1/3">
              <CardHeader>
                <CardTitle className="flex items-center gap-2 text-teal-600 dark:text-teal-400">
        ...
        <motion.section className="text-center mb-20" {...fadeIn}>
          <h2 className="text-3xl font-semibold mb-8 text-teal-600 dark:text-teal-400">Ready to Bridge Your Commits?</h2>
          <Button 
            size="lg" 
            className="bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl"
            onClick={() => setIsLoginModalOpen(true)}
          >
            Get Started Now
          </Button>
      ...
      <footer className="bg-gray-200 dark:bg-gray-900 text-center py-6 mt-16">
        <div className="container mx-auto px-4">
          ...
          <div className="flex justify-center space-x-4">
            <a href="https://x.com/arin_dhimar" target='_blank' className="text-gray-600 hover:text-teal-500 dark:text-gray-400 dark:hover:text-teal-300 transition-colors">
              <Twitter className="w-6 h-6" />
            </a>
            <a href="https://github.com/arindhimar" target='_blank' className="text-gray-600 hover:text-teal-500 dark:text-gray-400 dark:hover:text-teal-300 transition-colors">
              <Github className="w-6 h-6" />
            </a>
            <a href="https://www.linkedin.com/in/arin-dhimar" target='_blank' className="text-gray-600 hover:text-teal-500 dark:text-gray-400 dark:hover:text-teal-300 transition-colors">
              <Linkedin className="w-6 h-6" />
            </a>
            <a href="https://www.instagram.com/arin_dhimar_" target='_blank' className="text-gray-600 hover:text-teal-500 dark:text-gray-400 dark:hover:text-teal-300 transition-colors">
